...
namespace lve {
    ...
    // this choses between swap chain present modes i.e. vsync vs mailbox 
    VkPresentModeKHR LveSwapChain::chooseSwapPresentMode(
        ...
        // below is an alternative mode to mailbox if given graphics device doesn't support mailbox
